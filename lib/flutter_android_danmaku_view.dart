...
class FlutterAndroidDanmakuView extends StatefulWidget {
  ...
  @override
  State<FlutterAndroidDanmakuView> createState() => _FlutterAndroidDanmakuViewState();
}
...
class _FlutterAndroidDanmakuViewState extends State<FlutterAndroidDanmakuView> {
  ...
  Widget build(BuildContext context) {
    return AndroidView(viewType: "ANDROID/FLUTTER_ANDROID_DANMAKU_VIEW_ID",
...
class CustomViewController {
  ...
  Future<ResultInfo> startDanmaku(int? startTime) async {
    var result = await _channel.invokeMethod('startDanmaku', {'time': startTime?.toString()});
  ...
  Future<ResultInfo> sendDanmaku(String danmakuText, {bool isLive = false,
    String? time, int? danmakuType, int? padding, double? textSize, int? textColor,
    int? textShadowColor, int? underlineColor, int? borderColor
  }) async {
    var result = await _channel.invokeMethod('sendDanmaku', {'danmakuText': danmakuText,
      "isLive": isLive, "time": time, "danmakuType": danmakuType, "padding": padding,
      "textSize": textSize, "textColor": textColor, "textShadowColor": textShadowColor,
      "underlineColor": underlineColor, "borderColor": borderColor
    });
  ...
  Future<ResultInfo> setSpecialDanmakuVisibility(bool visible) async {
    var result = await _channel.invokeMethod('setSpecialDanmakuVisibility', {'visible': visible});
    return _handleResult("setSpecialDanmakuVisibility", result);
  }

  // 是否显示彩色弹幕
  Future<ResultInfo> setColorsDanmakuVisibility(bool visible) async {
    var result = await _channel.invokeMethod('setColorsDanmakuVisibility', {'visible': visible});
...
class ResultInfo {
  ...
  factory ResultInfo.fromJson(dynamic json) => ResultInfo(
    flag: json["flag"],
    method: json["method"],
    msg: json["msg"]
  );
